...
def test_seq_loader_multi_dev(dev_str, f, call):
    ...
    data_loader_spec = SeqDataLoaderSpec(dataset_spec, batch_size=2, window_size=1, starting_idx=0,
                                         num_sequences=1, container_load_mode='preload', array_mode='hdf5',
...
def test_seq_loader(dev_str, f, call, container_load_mode, array_mode, with_prefetching, shuffle_buffer_size):
    ...
    train_data_loader_spec = SeqDataLoaderSpec(dataset_spec, batch_size=batch_size, window_size=window_size,
                                               starting_idx=0, num_sequences=3, container_load_mode=container_load_mode,
                                               array_mode=array_mode, array_strs=['array'], float_strs=['depth'],
                                               uint8_strs=['rgb'], with_prefetching=with_prefetching,
                                               shuffle_buffer_size=shuffle_buffer_size, preshuffle_data=False)
    valid_data_loader_spec = SeqDataLoaderSpec(dataset_spec, batch_size=batch_size, window_size=window_size,
                                               starting_idx=3, num_sequences=3, container_load_mode=container_load_mode,
                                               array_mode=array_mode, array_strs=['array'], float_strs=['depth'],
                                               uint8_strs=['rgb'], with_prefetching=with_prefetching,
                                               shuffle_buffer_size=shuffle_buffer_size, preshuffle_data=False)
    ...
    data_loader_spec = SeqDataLoaderSpec(dataset_spec, batch_size=3, window_size=2, starting_idx=0,
                                         num_sequences=3, container_load_mode=container_load_mode,
...
def test_seq_loader_containers_to_skip(dev_str, f, call, container_load_mode, array_mode, with_prefetching, batch_size,
    ...
    dataset_spec = DatasetSpec(dataset_dirs, sequence_lengths=[2, 3, 2, 3, 3, 1], cont_fname_template='%06d_%06d.json')
    data_loader_spec = SeqDataLoaderSpec(dataset_spec, batch_size=batch_size, window_size=1, starting_idx=0,
                                         container_load_mode=container_load_mode, array_mode=array_mode,
                                         num_sequences=6, array_strs=['array'], float_strs=['depth'],
                                         uint8_strs=['rgb'], preshuffle_data=False, with_prefetching=with_prefetching,
                                         num_workers=1, containers_to_skip=containers_to_skip)
...
def test_seq_loader_wo_cont_load(dev_str, f, call, with_prefetching, shuffle_buffer_size):
    ...
    def custom_init_fn(self):
        alternative_data_dir = os.path.join(self._spec.dataset_spec.dirs.dataset_dir, 'containers_alternative/')
    ...
    dataset_spec = DatasetSpec(dataset_dirs, sequence_lengths=[2, 3, 2, 3, 3, 1], cont_fname_template='%06d_%06d.json')
    train_data_loader_spec = SeqDataLoaderSpec(dataset_spec, batch_size=batch_size, window_size=window_size,
                                               starting_idx=0, num_sequences=3, array_strs=['array'],
                                               with_prefetching=with_prefetching, container_load_mode='custom',
                                               shuffle_buffer_size=shuffle_buffer_size, preshuffle_data=False,
                                               custom_init_fn=custom_init_fn,
                                               custom_container_load_fn=custom_container_load_fn)
    valid_data_loader_spec = SeqDataLoaderSpec(dataset_spec, batch_size=batch_size, window_size=window_size,
                                               starting_idx=3, num_sequences=3, array_strs=['array'],
                                               with_prefetching=with_prefetching, container_load_mode='custom',
                                               shuffle_buffer_size=shuffle_buffer_size, preshuffle_data=False,
                                               custom_init_fn=custom_init_fn,
                                               custom_container_load_fn=custom_container_load_fn)
